...
all: ./bin/boot.bin ./bin/kernel.bin
	...
	sudo mount -t vfat ./bin/os.bin ./fsmount/
	# Copy A File Over
	sudo cp ./hello.txt ./fsmount/
	sudo umount ./fsmount/
...
./build/fs/pparser.o: ./src/fs/pparser.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -I./src/disk/ -std=gnu99 -c ./src/fs/pparser.c -o ./build/fs/pparser.o

./build/string/string.o: ./src/string/string.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -I./src/disk/ -std=gnu99 -c ./src/string/string.c -o ./build/string/string.o

./build/fs/file.o: ./src/fs/file.c
	i686-elf-gcc $(INCLUDES) $(FLAGS) -I./src/disk/ -std=gnu99 -c ./src/fs/file.c -o ./build/fs/file.o
